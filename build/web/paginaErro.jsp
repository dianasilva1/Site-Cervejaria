<%-- 
    Document   : paginaErro
    Created on : 25/11/2021, 19:24:53
    Author     : HOME
--%>
	    ...
	    <div class="row">
		    <div class="col-12 col-md-11 col-lg-7 col-xl-6 mx-auto">
			    <div class="app-branding text-center mb-5">
		            <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo"><span class="logo-text">Casa da Cerveja</span></a>
			    ...
			    <div class="app-card p-5 text-center shadow-sm">
				    ...
				    <a class="btn app-btn-primary" href="index.jsp">Voltar para o menu principal</a>
			    </div>
		    </div><!--//col-->
	    </div><!--//row-->
    </div><!--//container-->
