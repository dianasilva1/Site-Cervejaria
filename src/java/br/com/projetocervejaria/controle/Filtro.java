...
public class Filtro implements Filter {
   ...
   public void doFilter(ServletRequest request, ServletResponse response,
         ...
         //System.out.println("URL: "+url);
              String[]excecoes={"login.jsp", "/", "Login", ".css", ".js", ".jpg", ".png", "index.jsp", "pagina-contato.jsp", ".ico", "pagina-erro.jsp", "enviarMensagem"};
              ...
              if(liberar){
                  ...
                  requisicao.setAttribute("msg", "Acesso Negado!");
